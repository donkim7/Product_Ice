    ...
    <table class="product-table" id="myTable" >
        ...
        <tbody>
            ...
            foreach ($products as $product) {
                ...
                echo "<td>" . $product->productCost . "</td>";
                echo "<td>" . $product->productPrice . "</td>";
                echo "<td>" . $product->productUnit . "</td>";
                echo "<td>" . $product->saleUnit . "</td>";
                echo "<td>";
                echo "<button><a href='editproduct.php?product_id=" . $product->product_id . "' class='edit-button'>Edit</a></button>";
                echo "<button> <a href='deleteproduct.php?product_id=" . $product->product_id . "' class='delete-button'>Delete</a></button>";
                echo "</td>";
                echo "</tr>";
            }
            ?>
