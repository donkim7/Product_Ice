        ...
        <tbody>
            <?php
                    ...
                    foreach ($expenses as $expense) {
                        ...
                        echo "<td>" . $expense->expenseAmount . "</td>";
                        echo "<td>" . $expense->expenseDate . "</td>";

                        echo "<td>";
                        echo "<button ><a href='editexpenses.php?expense_id=" . $expense->expense_id . "' class='edit-button'>Edit</a> </button>";
                        echo "<button> <a href='delete_expense.php?expense_id=" . $expense->expense_id . "' class='delete-button'>Delete</a></button>";
                        echo "</td>";
                        echo "</tr>";
                    }
                    ?>
...
function searchTable() {
    ...
    for (i = 0; i < tr.length; i++) {
        td = tr[i].getElementsByTagName("td")[0]; // Search in the first column (Product Name)
        if (td) {
...
function showTodaysExpenses() {
    ...
    for (i = 0; i < tr.length; i++) {
        dateCell = tr[i].getElementsByTagName("td")[2]; // Date is in the 3rd column
        if (dateCell) {
