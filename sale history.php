        ...
        <tbody>
            <?php
                    ...
                    foreach ($sales as $sale) {
                        ...
                        echo "<td>" . $sale->saleItem . "</td>";
                        echo "<td>" . $sale->clientName . "</td>";
                        echo "<td>" . $sale->saleQuantity . "</td>";
                        echo "<td>" . $sale->saleUnit . "</td>";
                        echo "<td>" . $sale->salePrice . "</td>";
                        echo "<td>";
                        echo "<button><a href='editsales.php?sales_id=" . $sale->sales_id . "' class='edit-button'>Edit</a> </button>";
                        echo "<button> <a href='deletesale.php?sales_id=" . $sale->sales_id . "' class='delete-button'>Delete</a></button>";
                        echo "</td>";
                        echo "</tr>";
                    }
                    ?>
...
function showTodaysExpenses() {
    ...
    for (i = 0; i < tr.length; i++) {
        dateCell = tr[i].getElementsByTagName("td")[0]; // Date is in the 1rd column
        if (dateCell) {
